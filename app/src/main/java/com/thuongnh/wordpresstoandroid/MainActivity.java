package com.thuongnh.wordpresstoandroid;
...
public class MainActivity extends AppCompatActivity
    ...
    private void loadPostList(int categoryId) {
        String url = "http://teknoputra.com/wp-json/wp/v2/posts?filter[posts_per_page]=10&fields=id,title&categories=" + categoryId;
